...
Kawi supports all standard customizer options, like 'Site Identity' and 'Background Image', has an extended 'Header Image' section, and also features a new 'Layout' section, in which you can choose your sidebar position, and the featured image size you want to display on blog listing pages.
