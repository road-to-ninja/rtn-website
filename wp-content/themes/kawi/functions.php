...
function kawi_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'kawi' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Widgets added here will appear in a sidebar you can place on the left, right or bottom via a setting in the customizer. If no widgets are added, a one column layout will be used for all pages and posts.', 'kawi' ),
